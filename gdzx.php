                ...
                <div class="card">
                    <div class="card-body text-center">
					  ...
					  <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" class="zxzx">
					      ...
					      $_sql="select * from news where uid=3";
					      $_result=mysqli_query($conn,$_sql);
					      $nums=mysqli_num_rows($_result);
						  $pages=ceil($nums/$pagenums);
						  $sql3="select id,title,date from news where uid=3 order by date desc limit $pagestart,$pagenums";
						  $result3=mysqli_query($conn,$sql3);
						  while($rows3=mysqli_fetch_array($result3)){
						  ?>
						  <tr>
						 <td width="20" height="35">&hearts;</td>
                         <td style="text-align: left !important; padding-left: 25px; padding-top: 7px; padding-bottom: 7px;">
                        <a href="contents.php?id=<?php echo $rows3['id']?>"><?php echo $rows3["title"]; ?></a>
                        </td>
					  ...
					  <table width="350" align="center" border="0" cellpadding="0" cellspacing="0" class="zxzx1">
					  <tr>
						<td height="25"></td>  
					  </tr>
					  <tr>
						...
						<?php
						  ...
						  ?>
						  <td><a href="gdzx.php?page=1">首页</a></td>
						  <td><a href="gdzx.php?page=<?php echo $page-1;?>">上一页</a></td>
						  <?php }
						  if($page==$pages){?>
						  <td>下一页</td>
						  <td>尾页</td>
						  ...
						  <td><a href="gdzx.php?page=<?php echo $page+1;?>">下一页</a></td>
						  <td><a href="gdzx.php?page=<?php echo $pages;?>">尾页</a></td>
						  <?php }?>
					  </tr>
					  </table>
				  </td>
