 ...
 <div class="container-fluid">
    ...
    <ul class="list-unstyled">
        <li class="mb-3">
            ...
            <input type="text" name="username" class="form-control" value="<?php echo $rows["username"];?>" readonly/>
        </li>
        <li class="mb-3">
            <label for="password">密码：</label>
            <input type="password" name="password" class="form-control" value="<?php echo $rows["password"];?>" readonly/>
        </li>
        <li class="mb-3">
            <label>是否已经授权：</label>
            <br>
            <div class="btn-group" role="group" aria-label="Authorization">
                &nbsp;&nbsp;&nbsp;
                <input type="radio" name="pd" value="1" class="btn-check" id="pd1" <?php echo ($rows["pd"] == 1) ? 'checked' : ''; ?> readonly>
                <label class="btn btn-outline-danger <?php echo ($rows["pd"] == 1) ? 'active' : ''; ?>" for="pd1">未授权</label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="pd" value="2" class="btn-check" id="pd2" <?php echo ($rows["pd"] == 2) ? 'checked' : ''; ?> readonly>
                <label class="btn btn-outline-success <?php echo ($rows["pd"] == 2) ? 'active' : ''; ?>" for="pd2">已授权</label>
            </div>
        </li>
        <li class="mb-3">
            <label for="rq">注册时间：</label>
            <input type="rq" name="rq" class="form-control" value="<?php echo $rows["rq"];?>" readonly/>
        </li>
    </ul>
</form>
